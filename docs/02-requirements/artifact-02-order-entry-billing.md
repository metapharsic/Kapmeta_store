...
The reference screenshots show an ambiguous vertical icon rail next to the footer. Proposed interpretation, to be confirmed with stakeholder (Section 10), based on standard PetPooja-class POS feature parity:
