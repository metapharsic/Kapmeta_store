...
export interface PetPoojaKotViewProps {
  initialTickets?: KotCardData[];
  onMarkFoodReady?: (kotId: string) => void;
  onBackToPos?: () => void;
}

// Reference Dataset matching the exact screenshot from PetPooja POS
export const REFERENCE_KOT_TICKETS: KotCardData[] = [
  {
    id: "kot_14",
    kotNo: "14",
    orderType: "PICK_UP",
    orderTypeDisplay: "Pick Up",
    initialElapsedSeconds: 225 * 60 + 10, // 225:10
    biller: "biller (biller)",
    items: [{ id: "it_1", name: "Upma", quantity: 1 }],
    status: "PREPARING",
  },
  {
    id: "kot_15",
    ...
    orderType: "PICK_UP",
    orderTypeDisplay: "Pick Up",
    initialElapsedSeconds: 224 * 60 + 5, // 224:05
    biller: "biller (biller)",
    items: [
      { id: "it_2", name: "Filter Coffee", quantity: 4 },
      { id: "it_3", name: "Whole Wheat Biscuits 200gm", quantity: 1 },
      { id: "it_4", name: "Packing Charges", quantity: 1 },
    ],
    status: "PREPARING",
  },
  {
    ...
    orderTypeDisplay: "Pick Up",
    orderTag: "b18",
    initialElapsedSeconds: 204 * 60 + 12, // 204:12
    biller: "biller (biller)",
    items: [{ id: "it_5", name: "Masala Dosa", quantity: 1 }],
    status: "PREPARING",
  },
  {
    id: "kot_35",
    ...
    orderType: "PICK_UP",
    orderTypeDisplay: "Pick Up",
    initialElapsedSeconds: 196 * 60 + 45, // 196:45
    biller: "biller (biller)",
    items: [
      { id: "it_6", name: "(2) Idly (1) Vada", quantity: 2 },
      { id: "it_7", name: "Chitti Pesarattu", quantity: 1 },
    ],
    status: "PREPARING",
  },
  {
    ...
    orderTypeDisplay: "Pick Up",
    orderTag: "b14",
    initialElapsedSeconds: 190 * 60 + 16, // 190:16
    biller: "biller (biller)",
    items: [
      { id: "it_8", name: "Ghee Podi Dosa", quantity: 1 },
      { id: "it_9", name: "Vada", quantity: 1 },
    ],
    status: "PREPARING",
  },
  {
    ...
    orderType: "PICK_UP",
    orderTypeDisplay: "Pick Up",
    initialElapsedSeconds: 184 * 60 + 10, // 184:10
    biller: "biller (biller)",
    items: [{ id: "it_10", name: "Salt Biscuits 200gm", quantity: 1 }],
    status: "PREPARING",
  },
  {
    id: "kot_63",
    ...
    orderTypeDisplay: "Pick Up",
    orderTag: "b18",
    initialElapsedSeconds: 178 * 60 + 1, // 178:01
    biller: "biller (biller)",
    items: [{ id: "it_11", name: "Vada", quantity: 3 }],
    status: "PREPARING",
  },
  {
    id: "kot_64",
    ...
    orderTypeDisplay: "Pick Up",
    orderTag: "b3",
    initialElapsedSeconds: 177 * 60 + 9, // 177:09
    biller: "biller (biller)",
    items: [{ id: "it_12", name: "Onion Uttapam", quantity: 1 }],
    status: "PREPARING",
  },
];
...
export default function PetPoojaKotView({
  initialTickets = REFERENCE_KOT_TICKETS,
  onMarkFoodReady,
  onBackToPos,
}: PetPoojaKotViewProps) {
  ...
  return (
    <div className="petpooja-kot-view-root">
      {/* Toast notification */}
      {toastMessage && (
...
export { PetPoojaKotView as KapMetaKotView };
export type { PetPoojaKotViewProps as KapMetaKotViewProps };
