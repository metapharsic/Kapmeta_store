...
export interface PetPoojaOrderRowData {
  id: string;
  orderNo: string;
...
export interface PetPoojaOrdersViewProps {
  initialOrders?: PetPoojaOrderRowData[];
  onBackToPos?: () => void;
  onViewOrderDetails?: (orderId: string) => void;
  onPrintBill?: (orderId: string) => void;
}

// Reference dataset matching the exact screenshot
export const REFERENCE_CURRENT_ORDERS: PetPoojaOrderRowData[] = [
  {
    id: "ord_8012",
    orderNo: "8012",
    orderTypeTitle: "Dine In (B9)",
    orderTypeSubtitle: "(Non AC)",
    customerPhone: null,
    customerName: null,
    paymentType: "Cash",
    myAmount: 189.52,
    ...
    discount: 0.0,
    grandTotal: 198.0,
    created: "2026-08-21 11:40:35",
    status: "PRINTED_BILL",
  },
  {
    id: "ord_8011",
    orderNo: "8011",
    orderTypeTitle: "Dine In (B10)",
    orderTypeSubtitle: "(Non AC)",
    customerPhone: null,
    customerName: null,
    paymentType: "UPI",
    ...
    discount: 0.0,
    grandTotal: 119.0,
    created: "2026-08-21 11:38:29",
    status: "PRINTED_BILL",
  },
  {
    id: "ord_8010",
    orderNo: "8010",
    aggregatorTag: "Swiggy",
    orderTypeTitle: "Delivery",
    orderTypeSubtitle: "(Swiggy)",
    customerPhone: null,
  ...
  },
  {
    ...
    orderTypeSubtitle: "(Swiggy)",
    customerPhone: null,
    customerName: "rahul singh naik",
    paymentType: "Swiggy",
    myAmount: 265.4,
    tax: 8.64,
    discount: 92.4,
    grandTotal: 182.0,
    created: "2026-08-21 11:33:32",
    status: "PAID",
  },
  {
    id: "ord_8008",
    orderNo: "8008",
    orderTypeTitle: "Pick Up",
    orderTypeSubtitle: "(Pick Up)",
    customerPhone: null,
    customerName: null,
    paymentType: "UPI",
    myAmount: 120.0,
    ...
    discount: 0.0,
    grandTotal: 120.0,
    created: "2026-08-21 11:32:34",
    status: "PRINTED_BILL",
  },
  {
    id: "ord_8007",
    orderNo: "8007",
    orderTypeTitle: "Dine In (B15)",
    orderTypeSubtitle: "(Non AC)",
    customerPhone: null,
    customerName: null,
    paymentType: "UPI",
    ...
    discount: 0.0,
    grandTotal: 217.0,
    created: "2026-08-21 11:30:10",
    status: "PRINTED_BILL",
  },
];

export default function PetPoojaOrdersView({
  initialOrders = REFERENCE_CURRENT_ORDERS,
  onBackToPos,
  onViewOrderDetails,
  onPrintBill,
}: PetPoojaOrdersViewProps) {
  const router = useRouter();
  const [topTab, setTopTab] = useState<"CURRENT" | "ONLINE" | "ADVANCE">("CURRENT");
  ...
  const handleViewOrder = (order: PetPoojaOrderRowData) => {
  ...
  const handlePrint = (order: PetPoojaOrderRowData) => {
    if (onPrintBill) {
  ...
  return (
    <div className="petpooja-orders-view-root">
      {/* Toast Notification */}
      {toastMessage && (
      ...
      {/* Subheader 1: Top Navigation Tabs (Current Order | Online Order | Advance Order) */}
      <div className="orders-top-navbar">
        <div className="orders-tabs-left">
          <button
            type="button"
            className={`top-nav-tab-btn ${topTab === "CURRENT" ? "is-active" : ""}`}
          ...
          <button
            ...
            onClick={() => {
              setTopTab("ONLINE");
              router.push("/pending-order-detail");
            }}
          >
            Online Order
          </button>
...
export { PetPoojaOrdersView as KapMetaOrdersView };
export type { PetPoojaOrdersViewProps as KapMetaOrdersViewProps, PetPoojaOrderRowData as KapMetaOrderRowData };
